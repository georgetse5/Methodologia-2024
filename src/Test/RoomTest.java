...
public class RoomTest {
    ...
    Room livingRoom = new Room("Living Room", "A cozy living room",1,1);
    Room startingRoom = new Room("Starting Room", "A cozy starting room",1,1);

    Room hall_1 = new Hall_1("Hall", "First Room",1,1);
    Room hall_2 = new Hall_2("First floor hall", "Another long hallway",1,1);
    Room hall_3 = new Hall_3 ("Second floor hall", "A room with 4 doors",1,1);
    Room library = new Library("Library" , "A well persevered book collection",1,1);
    Room office = new Office("Office", "Seems like an ordinary office, you feel a draft behind the east bookcase",1,1);
