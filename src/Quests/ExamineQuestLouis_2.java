...
public class ExamineQuestLouis_2 extends Quest {
    ...
    public ExamineQuestLouis_2(String name, String description, String requiredItem) {
...
//                System.out.println("Required item found: " + requiredItem);
    ...
    public  void completeQuest(Player player) {
        if (itemFound) {
            ...
            System.out.println(color.red() + "You should go back to louis\n" + color.reset());
